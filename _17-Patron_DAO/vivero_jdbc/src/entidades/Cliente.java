...
//    public Cliente(int idCliente, String nombreCliente, String apellidoContacto) {
//        this(idCliente, 0 , nombreCliente, null, apellidoContacto, null, null, null, null, null, null , 0, 0);
//    }
    ...
    public String imprimirIdNombreApellido() {
        return """
                {\
                idCliente = %d, \
                nombreContacto = '%s', \
                apellidoContacto = '%s'\
                }""".formatted(idCliente, nombreContacto, apellidoContacto);
    }
